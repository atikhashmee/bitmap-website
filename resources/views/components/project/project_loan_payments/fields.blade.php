...
<div class="form-group col-sm-6">
   ...
   <input type="hidden" name="loans_id" value="{{ request()->route('loan_id') }}">
   <input type="hidden" name="project_id" value="{{ request()->route('project_id') }}">

<!-- Submit Field -->
<div class="form-group col-sm-12">
    {!! Form::submit('Save', ['class' => 'btn btn-primary']) !!}
    <a href="{!! route('projectLoanPayments.index',[request()->route('project_id'),request()->route('loan_id')]) !!}" class="btn btn-default">Cancel</a>
</div>
