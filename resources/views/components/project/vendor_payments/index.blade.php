                               ...
                               <div class="col-md-9">
                                    <div class="card content-section">
                                        ...
                                        <div class="card-header  content-header" > 
                                          ...
                                          <a href="{!! route('vendorPayments.create',request()->route('project_id')) !!}" 
                                        ...
                                        <div class="card-body">
                                            @include('flash::message')
                                           @include('components.project.vendor_payments.table')
                                         </div>
                                         <div class="card-footer">
                                             
                                       @include('adminlte-templates::common.paginate', ['records' => $vendorPayments])
