    ...
    <div class="col-md-9">
        <div class="card content-section">
            ...
            <div class="card-header  content-header">
                <h4>Employee Loan</h4>
                <a href="{!! route('employeeLoans.create') !!}" class='btn btn-warning float-right' style="position:absolute;top:10px;right:10px;"> Add new</a>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ url('Admin/Accounts/employeeLoans/filter') }}" method="POST">
                            @csrf
                            <div class="row p-2">
                                ...
                                <div class=" col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <select name="employee" class="form-control form-control-alternative">
                                            ...
                                            @foreach ($employeelist as $member)
                ...
                <div class="row">
                    <div class="col-md-12">
                        @include('components.accounts.employee_loans.table')
                    </div>
            ...
            <div class="card-footer">
                ...
                @include('adminlte-templates::common.paginate', ['records' => $employeeLoans])
