            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="teamheadline">
                     <div class="left-headline">{{ $tt->category_title}}</div>
               ...
               <div class="col-md-12">
                  <div class="each-members-container">
                     ...
                     <div class="row" id="foldinup_{{$loop->iteration}}">
                        <div class="col-md-3">
                           <a href="{{ url("Admin/Team/createForm/".$tt->id) }}"><div class="addnewbutton"></div></a>
                        </div>
                        @foreach ($teammembers as $member)
                           <div class="col-md-3">
                              <div class="card">
                                 <img class="card-img-top" src="{{ asset('storage/'.$member->memberimage) }}" alt="" />
                                 <div class="card-body">
                                 ...
                                 <div class="card-footer" style="padding:0px;">
                                    <ul style="display: flex; list-style:none;" >
                                       ...
                                       <li style="flex-basis: 100%;"> <a href="{{ url("Admin/Team/deleteMember/".$member->id) }}" onclick="return confirm('Are you sure?')"> <i class="fa fa-times" aria-hidden="true"></i> </a> </li>
                                    </ul>
                                 </div>
                              </div>
                           </div>
