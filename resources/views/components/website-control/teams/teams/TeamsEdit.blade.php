            ...
            <form action="{{ url("Admin/Team/updateMember/".$member->id) }}" class="form" method="post" enctype="multipart/form-data">
               ...
               <div class="form-group row">
                  <div class="col-md-10">
                     ...
                     <input type="hidden" name="dbmembertype" value="{{ $member->team_types_id }}" />
               ...
               <div class="form-group">
                  ...
                  <input class="form-control" type="text"  id="membername" name="membername" value="{{ $member->member_name }}" />
               </div>
               <div class="form-group">
                  <label for="example-search-input" class="col-form-label">Designation</label>
                  <input class="form-control" type="text" id="designation" name="designation" value="{{ $member->designation }}"/>
               </div>
               <div class="form-group">
                  <label for="example-url-input" class="col-form-label">description</label>
                  <input class="form-control" type="text" id="description" name="description" value="{{ $member->description }}"/>
               </div>
               <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <input id="my-input"  type="radio" name="visibilty" value="yes" @if ($member->visibility == 'yes')checked @endif/>  Yes
                  <input id="my-input"  type="radio" name="visibilty"  value='no'
                  @if ($member->visibility == 'no') checked @endif/>  No
               </div>
               <div class="form-group">
                  ...
                  <div class="row">
                        ...
                        <input class="form-control col-md-6" type="text" id="linedin" name="linedin" value="{{ $member->linkedin }}"/>
                  </div>
               </div>
               <div class="form-group">
                  ...
                  <div class="row">
                     ...
                     <input class="form-control col-md-6" type="text" id="twitterlink" name="twitterlink" value="{{ $member->twitter }}"/>
                  </div>
               </div>
               <div class="form-group">
                  ...
                  <div class="row">
                     ...
                     <input class="form-control col-md-6" type="text" id="instalink" name="instalink" value="{{ $member->instagram }}"/>
                  </div>
               </div>
               <div class="form-group">
                  <input type="hidden" name="dbpersonimage" value="{{ $member->memberimage }}"/>
