...
class ProductCategoryController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('components.products.product_categories.index')
    ...
    {
        return view('components.products.product_categories.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('components.products.product_categories.show')->with('productCategory', $productCategory);
    }
    ...
    public function edit($id)
    {
        ...
        return view('components.products.product_categories.edit')->with('productCategory', $productCategory);
    }
